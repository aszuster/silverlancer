...
const Services = () => {
  return (
    <div className="bg-slBeige py-[100px] overflow-hidden" id="services">
      <section className="lg:h-screen mx-[20px] lg:mx-[220px] flex flex-col justify-center">
...
<button className="bg-slLightBlue py-[10px] lg:py-[24px] px-[24px] lg:px-[48px] text-slBeige font-montserrat font-semibold text-[18px] lg:text-[24px] rounded-[46px] shadow-[0_2px_5px_2px_rgba(29,30,22,0.2)]">
  Quote Your Project
</button>
