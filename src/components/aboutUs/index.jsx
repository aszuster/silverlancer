...
const AboutUs = () => {
  return (
    <div className="bg-slBeige overflow-hidden lg:overflow-visible py-[100px] lg:py-5 relative" >
        <div id="aboutus" className="absolute top-[0px] lg:top-[-100px] xxl:top-[-120px] xxxl:top-[40px]"></div>
      <section className="mx-[20px] md:max-w-[75%] lg:max-w-[90%] xl:max-w-[80%] md:mx-auto xxxl:mx-[220px]">
        ...
        <div className="md:grid md:grid-cols-2 gap-x-[100px] gap-y-[75px] mb-[90px] lg:px-[100px] xl:px-0 xxxl:px-[100px]">
