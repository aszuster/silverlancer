...
const Contact = () => {
  return (
    <div className="bg-slBeige pt-[50px] lg:pt-[100px] pb-[200px] overflow-hidden lg:overflow-visible relative">
      <div
        id="contact"
        className="absolute top-[-45px] lg:top-[-20px] xxl:top-[-100px]"
      ></div>
      <section className="mx-[20px] md:max-w-[75%] lg:max-w-[90%] xl:max-w-[80%] md:mx-auto xxxl:mx-[220px] ">
        <div className="flex md:block lg:flex gap-[78px] justify-center mb-[50px] lg:mb-[200px]">
          ...
          <div>
            <h2 className="adelle text-slLightBlue font-light text-[45px] lg:text-[75px]">
              Send Us A Letter
            </h2>
            <ContactForm />
          </div>
        ...
        <div>
          <Link to="/terms-and-services">
            <p className="font-montserrat text-center underline uppercase font-light text-[24px] lg:text-[30px] text-slLightBlue termslink">
              Terms Of Service
            </p>
          </Link>
        </div>
